...
/*   Updated: 2024/05/21 21:28:40 by seunghan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	env_len_chk(t_list *tk_list, char *token);
...
int		add_pipe_input(t_tree_info *info, t_tree *now, t_list *tk_list, t_node *env_list);
